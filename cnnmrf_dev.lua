...
cmd:option('-style_scale', 1 , "style scaling relative to max_size'")
cmd:option('-normalize_gradients', false , "normalize gradients")
cmd:option('-pooling', 'avg', 'max|avg')
cmd:option('-optimizer', 'adam', 'lbfgs|adam')
cmd:option('-learning_rate', 1)
--cmd:option('-noise_name', 'potrait1', "The noise image'")
...
cmd:option('-type', 'transfer', 'Use Guided Synthesis (transfer) or development (dev)')
